...
![rex]({{ site.baseurl }}/assets/hacking-for-good-waves/rex.png)
...
![rex]({{ site.baseurl }}/assets/hacking-for-good-waves/long_beach.png)
...
![sources1]({{ site.baseurl }}/assets/hacking-for-good-waves/sources1.png)
...
![sources2]({{ site.baseurl }}/assets/hacking-for-good-waves/sources2.png)
...
![sources3]({{ site.baseurl }}/assets/hacking-for-good-waves/sources3.png)
...
![sources4]({{ site.baseurl }}/assets/hacking-for-good-waves/sources4.png)
...
![sources5]({{ site.baseurl }}/assets/hacking-for-good-waves/sources5.png)
...
![sources6]({{ site.baseurl }}/assets/hacking-for-good-waves/sources6.png)
...
![sources7]({{ site.baseurl }}/assets/hacking-for-good-waves/sources7.png)
...
1. Build data structure
    ...
    ![sources8]({{ site.baseurl }}/assets/hacking-for-good-waves/sources8.png)

2. Transform JSON object to JSON string via `JSON.stringify()` (opposite of JSON.parse)

    ![sources9]({{ site.baseurl }}/assets/hacking-for-good-waves/sources9.png)

3. Set cookie USERINFO to this value

    ![sources10]({{ site.baseurl }}/assets/hacking-for-good-waves/sources10.png)

4. Confirm it works :)

    ![sources11]({{ site.baseurl }}/assets/hacking-for-good-waves/sources11.png)


Now when the browser executes this script it will find the `'USERINFO'` cookie, parse it, and grant premium access.

![still-watching]({{ site.baseurl }}/assets/hacking-for-good-waves/still-watching.png)
...
![email]({{ site.baseurl }}/assets/hacking-for-good-waves/email.png)
